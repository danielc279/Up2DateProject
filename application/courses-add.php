...
<?php endif; ?>
                <textarea name="course-desc" rows="8" cols="80" placeholder="What are the details of this course?" class="form-control mb-3"><?php echo get_value($formdata, 'show-desc'); ?></textarea>
