...
-- -----------------------------------------------------
-- Table `db_up2date`.`tbl_user_roles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_up2date`.`tbl_user_roles` (
  `users_id` INT(11) UNSIGNED NOT NULL,
  `roles_id` TINYINT(2) UNSIGNED NOT NULL DEFAULT 3,
  INDEX `fk_table1_tbl_users1_idx` (`users_id` ASC),
  INDEX `fk_table1_tbl_user_roles1_idx` (`roles_id` ASC),
  CONSTRAINT `fk_table1_tbl_users1`
    FOREIGN KEY (`users_id`)
    REFERENCES `db_up2date`.`tbl_users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_table1_tbl_user_roles1`
    FOREIGN KEY (`roles_id`)
    REFERENCES `db_up2date`.`tbl_roles` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
