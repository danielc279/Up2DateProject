...
<?php if (has_error($formdata, 'user-name')): ?>
                        <div class="alert-danger mb-3 p-3">
                            <?php echo get_error($formdata, 'user-name'); ?>
                        </div>
<?php endif; ?>
                        <input type="text" name="user-name" class="form-control mb-3" placeholder="John"
                            value="<?php echo get_value($formdata, 'user-name'); ?>">

<?php if (has_error($formdata, 'user-surname')): ?>
                        <div class="alert-danger mb-3 p-3">
                            <?php echo get_error($formdata, 'user-surname'); ?>
                        </div>
<?php endif; ?>
